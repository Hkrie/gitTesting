            ...
            switch (i) {
                case 0:
                    switch (j) {
                        case 1:
                        case 8:
                            b[j].innerHTML = '<i class="fas fa-chess-rook chess_black"></i>';
                            break;
                        case 2:
                        case 7:
                            b[j].innerHTML = '<i class="fas fa-chess-knight chess_black"></i>';
                            break;
                        case 3:
                        case 6:
                            b[j].innerHTML = '<i class="fas fa-chess-bishop chess_black"></i>';
                            break;
                        case 4:
                            b[j].innerHTML = '<i class="fas fa-chess-queen chess_black"></i>';
                            break;
                        case 5:
                            b[j].innerHTML = '<i class="fas fa-chess-king chess_black"></i>';
                    }
                    break;
                case 1:
                ...
                case 7:
                    switch (j) {
                        case 1:
                        case 8:
                            b[j].innerHTML = '<i class="fas fa-chess-rook chess_white"></i>';
                            break;
                        case 2:
                        case 7:
                            b[j].innerHTML = '<i class="fas fa-chess-knight chess_white"></i>';
                            break;
                        case 3:
                        case 6:
                            b[j].innerHTML = '<i class="fas fa-chess-bishop chess_white"></i>';
                            break;
                        case 4:
                            b[j].innerHTML = '<i class="fas fa-chess-queen chess_white"></i>';
                            break;
                        case 5:
                            b[j].innerHTML = '<i class="fas fa-chess-king chess_white"></i>';
                    }
                    break;
                case 8:
                    if (j === 0) {
...
function chessMovement(e) {
    ...
    switch (chessMovement2(_this)) {
        ...
        case 1:
            ...
            break;
        default:
            console.log("impossible error at chessMovement");
    }
    return firstTarget;
}
...
const showPossibleMovements = (myTarget) => {
    ...
    switch (chessPiece[1]) {
        ...
        case "fa-chess-knight":
            ...
            break;
        default:
            console.log('unknown chess piece detected');
    }
};
